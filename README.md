...
We drilled out the middle of a nordic walking pole and replaced it with a button load cell. This combination of Arduino and Python code reads data from the walking pole via bluetooth and plots the data in real time. Data can be exported as a csv. <br />
